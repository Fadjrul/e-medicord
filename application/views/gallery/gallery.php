                ...
                <div class="card-content">
                    <div class="row me-4 mt-4">
                        <div class="col-md-12 col-12 text-end">
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" title="Tambah data" data-bs-target="#FormTambah"><i class="fas fa-plus"></i> Tambah
                            </button>
                            <a href="<?php echo site_url('gallery/data/photo')?>" class="btn btn-success btn-sm" title="Refresh halaman"><i class="bi bi-arrow-clockwise"></i> refresh</a>
                        </div>
                            <!-- Modal Tambah Galeri -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form>
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        <div class="form-group">
                                                            <?php echo csrf();?>
                                                            <input type="text" class="form-control" id="gallery_name" name="gallery_name" placeholder="Judul Galeri">
                                                ...
                                                <div class="row">
                                                    <div class="col-3">
                                                        <label>Cover Galeri <span style="color:red">*</span></label>
                                                    </div>
                                                    <div class="col-9">
                                                        <div class="form-group">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group dropstart mb-1">
                                                            <button type="button" class="btn btn-info btn-sm dropdown-toggle" data-bs-toggle="dropdown" title="Pilih Aksi" data-bs-display="static" aria-expanded="false"><i class="bi bi-three-dots-vertical"></i></button>
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a href="<?php echo site_url('gallery/all_photo/'.$key->gallery_id); ?>" class="dropdown-item" ><i class="bi bi-file-image"></i> Olah foto</a>
                                                                </li>
                                                                <li>
