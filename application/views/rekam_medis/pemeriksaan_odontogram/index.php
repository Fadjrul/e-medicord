                ...
                <div class="card-content">
                    <div class="row me-4">
                        <div class="col-md-12 col-12 text-end">
                            ...
                            <a href="<?php echo site_url('pemeriksaan_odontogram')?>" class="btn btn-success btn-sm" title="Refresh halaman"><i class="bi bi-arrow-clockwise"></i> refresh</a>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-hover" id="DataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($pemeriksaan_odontogram) {
                                            $nox = 1;
                                            $no = 1;
                                            foreach ($pemeriksaan_odontogram as $key) {
                                                        ...
                                                        <div class="btn-group dropstart mb-1">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <input type="hidden" class="form-control" name="pemeriksaan_odontogram_id" required="required" value="<?php echo $key->pemeriksaan_odontogram_id; ?>">
                                                                    <?php echo form_close(); ?>
                                                                </li>
                                                            </ul>
                                                        </div>
